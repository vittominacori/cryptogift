                ...
                <b-card class="shadow-lg" bg-variant="light">
                    ...
                    <b-form v-if="!makingTransaction" @submit.prevent="createGift">
                        <fieldset :disabled="!metamask.installed || makingTransaction">
                            ...
                            <b-alert show variant="info">Total price: {{ totalPrice }} ETH</b-alert>

                            <b-button type="submit" variant="success" size="lg">Submit</b-button>
                        </fieldset>
                    </b-form>
                    <div v-else>
                        <b-alert v-if="encryptionKey" show variant="warning">
                            Your encryption key is <b>{{ encryptionKey }}</b>.<br>
                            It allows receiver to decrypt your message. You must share it with Gift receiver.<br>
                        ...
                        <div v-if="trxHash">
                            ...
                            <b-alert v-if="tokenLink" show variant="success" class="mt-3">
                                <b>Visit your <a :href="tokenLink">Gift page</a>.</b>
                            </b-alert>
                            <div v-else>
...
<script>
  ...
  export default {
    ...
    computed: {
      totalPrice () {
        return parseFloat(this.price) + parseFloat(this.gift.value || 0);
      }
    },
    mounted () {

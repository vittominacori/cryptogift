        ...
        <b-col lg="10" offset-lg="1" class="text-center text-white p-0">
            <ul class="list-inline mt-2">
                <li class="list-inline-item">
                    <b-link class="text-light" to="/terms-of-use.html"><small>Terms of use</small></b-link>
                </li>
                <li class="list-inline-item">|</li>
                <li class="list-inline-item">
                    <b-link class="text-light" to="/privacy-policy.html"><small>Privacy policy</small></b-link>
                </li>
                <li class="list-inline-item">|</li>
